...
// regex: You received ([0-9]+.[0-9]+) USD from
template WiseSendAmountRegex(msg_bytes) {
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][1] * states[i+2][25];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][25] * states[i+2][2];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][2] * states[i+2][2];
