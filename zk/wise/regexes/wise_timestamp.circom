...
// regex: (\r\n|^)DKIM-Signature:([a-z]+=[^;]+; )+d=wise.com(; )t=[0-9]+;
template WiseTimestampRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[7][i].in[4] <== eq[24][i].out;
		multi_or[7][i].in[5] <== eq[25][i].out;
		multi_or[7][i].in[6] <== eq[26][i].out;
		multi_or[7][i].in[7] <== eq[27][i].out;
		multi_or[7][i].in[8] <== eq[28][i].out;
		multi_or[7][i].in[9] <== eq[29][i].out;
		...
		and[42][i].b <== eq[35][i].out;
		states[i+1][31] <== and[42][i].out;
		...
		and[49][i].b <== eq[39][i].out;
		states[i+1][38] <== and[49][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][22] * states[i+2][23];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][23] * states[i+2][23];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][21] * states[i+2][22];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][22] * states[i+2][22];
